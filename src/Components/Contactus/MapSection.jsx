...
const MapSection = () => {
  return (
    <div className="flex flex-col md:flex-row items-center">
      <div className="bg-blue-600 md:w-1/3 h-[450px] p-8">
        ...
        <div className="text-white text-left flex mb-8"> 
          <img src={Phone} alt="" className="w-4 h-4 mr-1"/>+91 636761717171
        </div>
        <div className="text-white flex text-left mb-4"> 
          <img src={Phone} alt="" className="w-4 h-4 mr-1"/>support@riofinassets.com
        </div>
      ...
      <div className="bg-blue-500 md:w-2/3 h-[450px]">
        <iframe
          title="hello"
