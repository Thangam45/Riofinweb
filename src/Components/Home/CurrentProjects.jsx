...
import Rectangle from '../../assests/projects.png';
...
const CurrentProjects = () => {
  ...
  return (
    <div className='md:w-full md:ml-2 md:mb-2'>
      <div className="bg-white mt-10 mx-auto md:ml-8 px-1">
        <section className="flex flex-col-reverse md:flex-row mb-8">
          <div className="w-full md:mb-0">
            ...
            <div className='flex items-center mb-2'>
              <FaAccusoft className='text-blue-400 text-sm mr-1' />
